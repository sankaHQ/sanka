    ...
    for project_name, expected_license in EXPECTED_LICENSES.items():
        ...
        if project_name == "sanka-cli":
            ...
            required_imports = {
                ...
                "sanka_extensions/flow/blueprint.py",
                "sanka_extensions/flow/graph.py",
                "sanka_extensions/flow/identity.py",
                "sanka_extensions/flow/protocol.py",
                "sanka_extensions/flow/scenario.py",
                "sanka_extensions/flow/source.py",
