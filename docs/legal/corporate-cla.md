...
"**You**" (or "**Your**") shall mean the Corporation that is making this
Agreement with Sanka. For legal entities, the entity making a Contribution
...
It is Your responsibility to notify Sanka when any change is required to the
list of designated employees authorized to submit Contributions on behalf of
the Corporation, or to the Corporation's point of contact with Sanka.
...
*Initial list of employees authorized to submit Contributions on behalf of
the Corporation (name, email, GitHub username):*
