...
- Source candidate: both package `pyproject.toml` files define `0.1.0a6`; the
  matching `v0.1.0a6` tag is the source release authority after the reviewed
...
make check
make build-release
uv run python scripts/check_release_tag.py v0.1.0a6 tag
```
