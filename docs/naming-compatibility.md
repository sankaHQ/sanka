...
| --- | --- | --- |
| `ConnectorRegistry`, `UnknownConnectorError` imports | `ExtensionRegistry`, `UnknownSystemError` | Source aliases; remove in an announced incompatible runtime release after callers migrate |
...
| `ExtensionStore.connector_providers`, `resolve_connector` | `supported_systems`, `resolve_extension` | Method aliases for existing runtime clients |
