...
"""The Ferry connector SPI: base protocols plus optional capability protocols.
...
from ferry.connector.credentials import Credentials
...
from ferry.connector.schema import Inventory, ProviderIdentity, SourceObject
