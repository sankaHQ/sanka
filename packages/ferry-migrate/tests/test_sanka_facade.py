...
def test_public_and_compatibility_namespaces_share_the_runtime() -> None:
    assert sanka.__version__ == ferry.runtime.__version__
    assert sanka.MigrationPlan.__module__ == "ferry.runtime.planner"
    assert sanka.MigrationSpec.__module__ == "ferry.runtime.spec"
    assert sanka.ExecutionError.__module__ == "ferry.runtime.engine"
