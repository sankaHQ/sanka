...
@pytest.mark.parametrize(
    ...
    [
        ...
        "sanka_extensions/flow/protocol.py",
        "sanka/runtime/flow/extension.py",
...
def test_unified_release_artifact_contains_three_license_zones(
    ...
    wheel_members = {
        ...
        "sanka_extensions/flow/blueprint.py": b"",
        "sanka_extensions/flow/graph.py": b"",
        "sanka_extensions/flow/identity.py": b"",
        "sanka_extensions/flow/protocol.py": b"",
        "sanka_extensions/flow/scenario.py": b"",
        "sanka_extensions/flow/source.py": b"",
        "sanka/runtime/flow/extension.py": b"",
