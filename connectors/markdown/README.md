# ferry-connector-markdown

Reads a directory of Markdown files as a Ferry migration **source**: YAML
...
frontmatter. Apache-2.0; depends only on `ferry-connector-sdk` (+ PyYAML).
